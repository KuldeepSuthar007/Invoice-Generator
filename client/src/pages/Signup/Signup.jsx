...
function SignupComponent({ login, setLogin }) {
      ...
      <div className={style.formcontainer}>
        ...
        <form action="" onSubmit={handlesignup}>
          ...
          <p className={style.h4}>
            ...
            EasyInvoiceGenerator. Message and data rates may apply.
          </p>
        ...
        <p className={style.term}>
          By continuing, you agree to EasyInvoiceGenerator privacy notice and
          conditions of use.
        </p>
      </div>
